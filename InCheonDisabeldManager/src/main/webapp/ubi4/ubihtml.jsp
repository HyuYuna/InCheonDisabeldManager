...
%>
<%
	String jrf = nullToStr(request.getParameter("jrf"), "dbtest.jrf");
	String arg = nullToStr(request.getParameter("arg"), "arg#value123#image#http://www.ubireport.com/images/logo.jpg");
