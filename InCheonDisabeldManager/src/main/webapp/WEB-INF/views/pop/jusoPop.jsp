...
<% 
	...
	String confmKey = "U01TX0FVVEgyMDIwMDkxNzE1MzY1MjExMDIwNDI="; // 검색API 승인키
...
<script type="text/javascript" src="/resources/js/jquery/addrlink.js"></script>
<link rel="stylesheet" type="text/css" href="/resources/css/addrlink.css"></link>
...
<script language="javascript">
	...
	function setParent(){
		...
		opener.jusoCallBack(rtRoadFullAddr, rtZipNo, rtAddrPart1, rtAddrDetail, rtAddrPart2, rtEngAddr, rtJibunAddr, rtAdmCd, rtRnMgtSn, rtBdMgtSn, rtDetBdNmList, rtBdNm, rtBdKdcd, rtSiNm, rtSggNm, rtEmdNm, rtLiNm, rtRn, rtUdrtYn, rtBuldMnnm, rtBuldSlno, rtMtYn, rtLnbrMnnm, rtLnbrSlno, rtEmdNo);
