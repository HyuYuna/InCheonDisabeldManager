		...
		<table class="dataTable marginT20">
            ...
            <tbody>
                <tr>
					<th>도서분류명</th>
					<td class="title">
						<input type="text" name="schCatalogNo" id="schCatalogNo" style="width:100%;" onkeypress="fn_pressItem(this.form);" tabindex="1">
					</td>
				</tr>
			</tbody>
		</table>
...
<script type="text/javascript" >
	...
	// AUIGrid 칼럼 설정
	var columnLayout = [ 
		 {dataField : "catalogNo", headerText : "분류코드", width : "30%", style : "my-column-center"},
		 {dataField : "catalogNm", headerText : "분류명", width : "60%", style : "my-column-left"},
	...
	$(function () {
		...
		$fid = (winName=="searchLbrryBookCatalogPop") ? "schCatalogNo" : "catalogNo";
		
		$("#schCatalogNo").val($(opener.document).find(".<%=layerName%> #"+$fid).val());
	...
	function loadData () {
		...
		var sendData ={"schCatalogNo"  : $("#schCatalogNo").val()};
