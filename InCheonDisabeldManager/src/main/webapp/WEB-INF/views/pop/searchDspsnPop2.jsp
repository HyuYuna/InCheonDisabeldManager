...
<script type="text/javascript" >
	...
	$(function () {
		...
		} else if($(opener.document).find(".<%=layerName%> #dspsnPopValue").val() == 2){
			$("#searchDspsnNm").val($(opener.document).find(".<%=layerName%> #assDspsnNm").val());
			$(".searchHide").hide();
			$(".popupSearchBtn").hide();
		} else if($(opener.document).find(".<%=layerName%> #dspsnPopValue").val() == 3){
			$("#searchDspsnNm").val($(opener.document).find(".<%=layerName%> #dspsnNm").val());
			$(".searchHide").hide();
			$(".popupSearchBtn").hide();
		}
		else{
